...
export default function ManageCreditsPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#F3F7FA', fontFamily: font, color: '#1B303D', padding: 20 }}>
      <section style={{ maxWidth: 720, margin: '0 auto', background: '#fff', border: '1px solid #D8E1E8', borderRadius: 10, padding: 20 }}>
