...
function Content() {
  ...
  if (!code) return <div className="p-10">No assignment code.</div>;
    ...
    <main className="min-h-screen bg-slate-300 flex items-center justify-center">
      <div className="bg-white p-8 rounded-xl shadow-xl w-[600px] space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p><b>Assignment:</b> {d.CourseName}</p>
        ...
        <div className="bg-slate-100 border rounded-lg p-4 space-y-2 text-sm">
          ...
          <ul className="list-disc ml-5 space-y-1">
            ...
            <li>You must pass the final test with 80% or higher to receive your final report.</li>
            <li>Your progress is saved automatically.</li>
            <li>You may leave and return later using the same assignment code.</li>
