...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('[employer-portal] Could not load admins:', error);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error('[employer-portal] Could not add admin:', error);
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    console.error('[employer-portal] Could not remove admin:', error);
