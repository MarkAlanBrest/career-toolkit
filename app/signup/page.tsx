...
function SignupWidget() {
  ...
  const [courseId, setCourseId] = useState(params.get('course_id') || params.get('courseId') || '');
  ...
  useEffect(() => {
    const onMsg = (evt: MessageEvent) => {
      ...
      if (evt.data.className || evt.data.courseName) setClassName(evt.data.className || evt.data.courseName);
      if (evt.data.term) setTerm(evt.data.term);
    };
      ...
      <div style={S.page}>
        <div style={{ textAlign: 'center', color: '#fff', padding: 32 }}>
          ...
          <div style={{ ...S.title, marginTop: 10 }}>
            You&rsquo;re signed up{studentName ? `, ${studentName.split(' ')[0]}` : ''}!
          </div>
          ...
          <div style={S.headline}>
            <div style={S.titleRow}>
              ...
              <div>
                ...
                <div style={S.sub}>
                  {studentName
                    ? <>Hi, <strong>{studentName.split(' ')[0]}</strong>! Get class updates sent to your phone.</>
