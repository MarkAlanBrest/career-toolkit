...
function SignupWidget() {
  ...
  // Class and term come from URL params generated by the teacher's embed code.
  // Student name comes from the extension bridge (nice-to-have, not required).
  ...
  useEffect(() => {
    ...
    const onMsg = (evt: MessageEvent) => {
      ...
      if (evt.data.name) setStudentName(evt.data.name);
    };
