  ...
  try {
    ...
    async function mountSpeedGraderToolbar() {
      ...
      style.textContent = `
        ...
        #ce-sg-toolbar { position:relative; width:100%; height:52px; z-index:2147483640; overflow:visible; isolation:isolate; border-bottom:1px solid #c7cdd1; background:#fff; color:#394B58; font-family:-apple-system,BlinkMacSystemFont,"Lato","Segoe UI",sans-serif; box-sizing:border-box; box-shadow:0 1px 4px rgba(0,0,0,.06); }
        ...
        .ce-sg-brand { flex-shrink:0; height:38px; border-right:1px solid #dde1e4; color:#394B58; display:flex; align-items:center; gap:9px; padding:0 14px 0 8px; white-space:nowrap; margin-right:4px; }
        ...
        .ce-sg-brand-copy small { font-size:9px;color:#8b98a3;font-weight:600;margin-top:3px;letter-spacing:.2px; }
        .ce-sg-btn { height:34px; padding:0 12px; flex-shrink:0; border:1px solid #d5dbe0; border-radius:7px; background:#fff; color:#394B58; cursor:pointer; font-family:inherit; font-size:12px; font-weight:700; letter-spacing:.1px; white-space:nowrap; transition:background .12s,color .12s,border-color .12s; position:relative; }
        ...
        .ce-sg-btn:hover { background:#EAF3FB; border-color:#B8DAF0; color:#0B6FB0; }
        .ce-sg-btn-primary { background:#EAF3FB !important; border-color:#B8DAF0 !important; color:#0B6FB0 !important; }
        .ce-sg-btn-ai { background:#fff !important; color:#0B6FB0 !important; border-color:#B8DAF0 !important; border-radius:999px !important; box-shadow:none; }
        .ce-sg-btn-ai:hover { background:#EAF3FB !important; color:#075686 !important; border-color:#0B6FB0 !important; }
        ...
        .ce-sg-menu-item:hover { background:#EAF3FB;color:#0B6FB0; }
        .ce-sg-menu-item-ai { background:none;color:#2d3b45;border:0;border-radius:0; }
        .ce-sg-menu-item-ai:hover { background:#EAF3FB;color:#0B6FB0; }
        .ce-sg-menu-item span:first-child { width:20px;text-align:center;font-size:14px; }
        .ce-sg-collapse { margin-left:auto; }
        #ce-sg-tab { position:relative; margin-left:auto; z-index:10; width:148px; height:28px; border:1px solid #d5dbe0; border-top:none; border-radius:0 0 0 7px; background:#fff; box-shadow:0 1px 4px rgba(0,0,0,.06); color:#394B58; font:700 11px/1 inherit; cursor:pointer; display:none; align-items:center; justify-content:center; }
