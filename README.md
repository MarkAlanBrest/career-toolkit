...
25 broadcast attempts. A test action accepts a Canvas course URL and posts only in that course.
For safety, the server blocks test courses containing more than one active student.
